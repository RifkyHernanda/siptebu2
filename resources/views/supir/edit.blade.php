...
route('supir.update', $data-> ID_SUPIR) }}">
@csrf
<div class="mb-3">
...
<div class="mb-3">
 ...
 <input type="text" class="form-control" id="NAMA_SUPIR" name="NAMA_SUPIR" value="{{ $data->NAMA_SUPIR}}">
 </div>
 <div class="mb-3">
 <label for="NOPOL_KENDARAAN" class="form-label">Nopol Kendaraan</label>
 <input type="text" class="form-control" id="NOPOL_KENDARAAN" name="NOPOL_KENDARAAN" value="{{ $data->NOPOL_KENDARAAN}}">
 </div>
 <div class="mb-3">
